...
const cards = [
  {
    title: "About Akshesh Hotel",
    icon: <Building2 className="w-6 h-6" />,
    content:
      "Akshesh Hotel is located on the outskirts of Bishoftu/Debre Zeit, 42 km from Addis Ababa. Once a family farm, it became part of the town during the late 1980s. As Bishoftu grew into a popular tourism and leisure destination, Akshesh Hotel emerged as a modest yet reliable hospitality provider.",
  },
  {
    title: "Facilities",
  ...
  },
  {
    ...
    content:
      "Surrounded by lush gardens, Akshesh Hotel provides a peaceful retreat ideal for relaxation, writing, reflection, and group escapes. Guests can use the open kitchen or pre-order personalized meals while enjoying professional hospitality from an experienced management team.",
  },
  {
    title: "Who We Are",
    icon: <Target className="w-6 h-6" />,
    content:
      "Akshesh Hotel is a sanctuary for rest and renewal. Built on strong values, it focuses on guests' mental, emotional, and spiritual wellbeing through disciplined service, comfort, quality, and genuine hospitality.",
  },
  {
    title: "Future Vision",
    icon: <Rocket className="w-6 h-6" />,
    content:
      "With Bishoftu rapidly growing as a tourism destination and the planned construction of Africa's largest airport nearby, Akshesh Hotel plans to double its capacity within five years to meet increasing hospitality demand.",
  },
];
        ...
        <div className="Rosmery-inner">
          ...
          <div className="Rosmery-header">
            ...
            <h2 className="Rosmery-title">
              Welcome to <em>Akshesh Hotel</em>
            </h2>
